...
```
Crm_Login 1.0.html                        — Сторінка входу + адмін-панель (946 рядків)
Crm_posylki 3.0.html                      — CRM для посилок (7658 рядків)
Crm_pass_19.1v.html                       — CRM для пасажирів (6861 рядків)
Yura_driyv_cod_1.0.html                   — Додаток для водіїв (1813 рядків)
Crm_new_skript_posylki_1.0.gs             — API посилок (1192 рядків)
Crm_new_skript_passanger_1.0.gs           — API пасажирів (1830 рядків)
Crm_new_skript_marwrut_posylki_1.0.gs     — API маршрутів посилок (1512 рядків)
Crm_new_skript_marwrut_passanger_1.0.gs   — API маршрутів пасажирів (1637 рядків)
Crm_Arhiv_1.0.gs                          — API архіву (1343 рядків)
```
...
### API Посилок (`Crm_new_skript_posylki_1.0.gs`)
...
### API Пасажирів (`Crm_new_skript_passanger_1.0.gs`)
...
### API Маршрутів Посилок (`Crm_new_skript_marwrut_posylki_1.0.gs`)
`getDeliveries`, `getAvailableRoutes` — для водіїв

### API Маршрутів Пасажирів (`Crm_new_skript_marwrut_passanger_1.0.gs`)
`getPassengers`, `getAvailableRoutes` — для водіїв

### API Архіву (`Crm_Arhiv_1.0.gs`)
...
### Сторінка входу (`Crm_Login 1.0.html`)
- Вибір ролі, форми логіну, адмін-панель

### CRM Посилок (`Crm_posylki 3.0.html`)
...
### CRM Пасажирів (`Crm_pass_19.1v.html`)
...
### Додаток водія (`Yura_driyv_cod_1.0.html`)
